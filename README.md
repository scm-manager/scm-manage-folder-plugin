...
Create empty folders through the web interface.

## Usage

Find out how this plugin works on the [plugin documentation page](https://www.scm-manager.org/plugins/scm-manage-folder-plugin/docs/).
